...
contract Crowdsale is Context, ReentrancyGuard, Ownable {
    ...
    */
    ...
    function getFinalizeICO() public view returns (bool) {
        return finalizeStatus;
    }
    
    function setBackFinalizeICO() public onlyOwner {
        finalizeStatus = false;
    }
    ...
    function finalizeICO() public onlyOwner {
        statusICO = false;
        finalizeStatus = true;
        _deliverTokens(address(owner()), crowdSaleSupply.sub(_weiRaised));
    }
}
